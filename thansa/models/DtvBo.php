 ...
 */
class DtvBo extends ActiveRecord {
    ...
    public function rules() {
        return [
            [['name','loai','id_dtv_lop'], 'required'],
            [['loai', 'id_dtv_lop', 'status', 'created_by', 'updated_by'], 'integer'],
