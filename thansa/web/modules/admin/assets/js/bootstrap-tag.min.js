!function (c) {
    ...
    b.prototype = {constructor: b, show: function () {
            ...
            d.input = c('<input type="text">').attr("placeholder", d.options.placeholder)
                    .attr("maxlength", d.options.maxlength)
                    .attr("class", d.options.class)
                    .insertAfter(d.element).on("focus", function () {
...
//                        }
    ...
    c.fn.tag.defaults = {allowDuplicates: false, caseInsensitive: true, placeholder: "", maxlength: "", class: "", source: []};
