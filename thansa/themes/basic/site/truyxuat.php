...
<div id="content">
    ...
    <div class="truyxuat" style="min-height: 600px;">
        ...
        <marquee><h2>Cơ sở dữ liệu đa dạng sinh học về động vật<span></span></h2></marquee>
            <?php
                ...
                <div class="tintuc" style="display: inline-block;margin-top: 20px; width:100%">
                    <div class="noibat">
                        <div class="tinnoibat" style="width: 100%">
                            <h3><a href="javascript:;">Danh sách động vật - Số lượng: <?= $count;?><span></span></a></h3>
                                        ...
                                        ?>
                                            ...
                                            <div class="tin1 col-sm-6">
                                                ...
                                                ?>
                                                    ...
                                                    <h4><a href="<?= $url ?>">Loài: <?= $item['name'] ?></a></h4>
                                                    <?php
...
<script type="text/javascript">
    ...
    function selected_loai(value) {
        ...
        jQuery('#dtv_ndcp').html('<option value="" selected="selected">Nghị định 84/NĐ-CPP</option>');
        ...
        jQuery('#dtv_ndcp64').html('<option value="" selected="selected">Nghị định 64/NĐ-CP</option>');
        if (typeof listndcp64[value] != 'undefined') {
            for (var i in listndcp64[value]) {
                jQuery('#dtv_ndcp64').append('<option value="' + i + '">' + listndcp64[value][i] + '</option>');
            }
        }
    }
