...
/**
 * DtvboController implements the CRUD actions for DtvHo model.
 */
class DtvboController extends AdminController {
    ...
    public function setParamModel($model) {
        ...
        $model->id_dtv_lop = ((int) $model->id_dtv_lop) ? (int) $model->id_dtv_lop : NULL;
        return $model;
    }

    public function actionCreate() {
        $model = new AdminDtvBo();
