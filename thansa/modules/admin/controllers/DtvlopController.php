...
/**
 * DtvlopController implements the CRUD actions for DtvLop model.
 */
class DtvlopController extends AdminController {
    ...
    /**
     * Lists all DtvLop models.
     * @return mixed
     */
    public function actionIndex() {
        $searchModel = new AdminDtvLop();
    ...
    public function setParamModel($model) {
        ...
        $model->id_dtv_nganh = ((int) $model->id_dtv_nganh) ? (int) $model->id_dtv_nganh : NULL;
        return $model;
    }

    public function actionCreate() {
        $model = new AdminDtvLop();
