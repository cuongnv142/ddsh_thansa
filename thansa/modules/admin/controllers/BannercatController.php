...
class BannercatController extends AdminController {
    ...
    public function actionIndex() {
        $searchModel = new AdminBannerCat();
    ...
    public function saveByLang($model) {
        ...
        if ($model->parent_id) {
            $parent = AdminBannerCat::findOne($model->parent_id);
            if ($parent) {
    ...
    protected function findModel($id) {
        $model = AdminBannerCat::findOne($id);
        if (!$model) {
