...
use app\models\DtvLop;
use app\modules\admin\behaviors\LogActionBehavior;
use Yii;
use yii\data\ActiveDataProvider;

/**
 * AdminDtvLop represents the model behind the search form of `app\models\DtvLop`.
 */
class AdminDtvLop extends DtvLop {
    ...
    public function search($params) {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'loai' => $this->loai,
            'id_dtv_nganh' => $this->id_dtv_nganh,
            'status' => $this->status,
