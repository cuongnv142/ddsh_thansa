        ...
        <div class="cat-re-index">
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'id_dtv_nganh',
                        'format' => 'raw',
                        'filter' => ArrayHelper::map(AdminDtvNganh::find()->where(['loai' => $searchModel->loai])->orderBy('name')->all(), 'id', 'name'),
                        'value' => function($data) {
                            return AdminDtvNganh::getParentName($data->id_dtv_nganh);
                        }
                    ],
                    [
