...
<div class="banner-form">
    ...
    ?>
    <?= $form->field($model, 'id_dtv_nganh')->dropDownList(ArrayHelper::map(AdminDtvNganh::find()->where(['loai' => $model->loai])->orderBy('name')->all(), 'id', 'name'), ['prompt' => 'Lựa chọn', 'class' => 'width-40 chosen-select']) ?>
