            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw', //raw, html
                        'filter' => AdminMenus::$arrGroupMenu,
                        'content' => function ($data) {
                            return AdminMenus::$arrGroupMenu[(int) $data->menu_group_id];
                        }
                    ],
                    [
                        'attribute' => 'name',
                    ...
                    [
                        'attribute' => 'type_menu',
                        'format' => 'raw', //raw, html
                        'filter' => AdminMenus::$arrTypeMenu,
                        'content' => function ($data) {
                            return AdminMenus::$arrTypeMenu[(int) $data->type_menu];
                        }
                    ],
                    [
                        'attribute' => 'parent_id',
                        'format' => 'text', //raw, html
                        'filter' => ArrayHelper::map(AdminMenus::getMenusLevel(0, 0, $searchModel->menu_group_id, $searchModel->language), 'id', 'name'),
                        'content' => function ($data) {
                            return AdminMenus::getParentName($data->parent_id);
                        }
                    ],
                    [
