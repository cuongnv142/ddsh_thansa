            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'id_dtv_ho',
                        'format' => 'raw',
                        'filter' => ArrayHelper::map(AdminDtvHo::find()->where(['loai' => $searchModel->loai])->orderBy('name')->all(), 'id', 'name'),
                        'value' => function($data) {
                            return AdminDtvHo::getParentName($data->id_dtv_ho);
                        }
                    ],
                    [
