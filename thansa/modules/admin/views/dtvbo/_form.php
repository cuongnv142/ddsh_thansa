...
<div class="banner-form">
    ...
    ?>
    <?= $form->field($model, 'id_dtv_lop')->dropDownList(ArrayHelper::map(AdminDtvLop::find()->where(['loai' => $model->loai])->orderBy('name')->all(), 'id', 'name'), ['prompt' => 'Lựa chọn', 'class' => 'width-40 chosen-select']) ?>
