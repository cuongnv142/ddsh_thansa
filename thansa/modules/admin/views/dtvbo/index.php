        ...
        <div class="cat-re-index">
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'id_dtv_lop',
                        'format' => 'raw',
                        'filter' => ArrayHelper::map(AdminDtvLop::find()->where(['loai' => $searchModel->loai])->orderBy('name')->all(), 'id', 'name'),
                        'value' => function($data) {
                            return AdminDtvLop::getParentName($data->id_dtv_lop);
                        }
                    ],
                    [
