...
<div class="admin-banner-cat-form">
    ...
    <?php
    echo $form->field($model, 'parent_id')->dropDownList(ArrayHelper::map(AdminBannerCat::getBannerCatLevel($model->id, $model->level, $model->language), 'id', 'name'), ['prompt' => 'Danh mục gốc', 'class' => 'width-40 chosen-select']);
    ?>
    <?php
