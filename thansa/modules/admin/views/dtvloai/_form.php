...
<div class="banner-form">
    ...
    <div class="col-sm-2">
        <?php echo Html::activeDropDownList($model, 'muc_do_bao_ton_ndcp', AdminDtvLoai::$arrMucDoBaoTonNDCP[$model->loai], ['prompt' => 'Nghị định 84/NĐ-CP', 'class' => 'width-98 chosen-select']); ?>
    </div>
    <div class="col-sm-2">
        <?php echo Html::activeDropDownList($model, 'muc_do_bao_ton_nd64cp', AdminDtvLoai::$arrMucDoBaoTonNDCP[$model->loai], ['prompt' => 'Nghị định 64/NĐ-CP', 'class' => 'width-98 chosen-select']); ?>
    </div>
    <?php
